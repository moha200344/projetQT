...
struct qt_meta_stringdata_CLASSemployeENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSemployeENDCLASS = QtMocHelpers::stringData(
    "employe",
    "on_ajout_clicked",
    "",
    "clearFields",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSemployeENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject employe::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSemployeENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSemployeENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSemployeENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void employe::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->on_tabWidget_2_currentChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->on_tabWidget_2_tabBarClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
...
void *employe::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSemployeENDCLASS.stringdata0))
